							...
							<div class="col-md-4">
								<div class="mb-0 flex-grow">
									...
									<p class="mb-0 font-weight-light">
										Đơn hàng hoàn tất là đơn hàng mà
										<br />
										khách hàng thêm sản phẩm vào giở hàng
										<br />
										và đã hoàn tất thanh toán.
									</p>
								</div>
							</div>
							<div class="col-md-4">
								<img
									width="100%"
									height="400"
									src="https://bizweb.dktcdn.net/assets/admin/images/empty-states/abandon_checkout.svg"
								/>
							</div>
							<div class="col-md-2"></div>
						</div>
							...
							<template slot-scope="{ data }">
								<vs-tr :key="indextr" v-for="(tr, indextr) in data">
									...
									<vs-td :data="tr.id">
										...
										<vs-chip color="danger" v-if="tr.payment_status == 0">
											Chưa thanh toán
										</vs-chip>
									</vs-td>
									<vs-td :data="tr.id">
...
export default {
	...
	methods: {
		...
		draftBills() {
			this.loadings(true);
			this.draftBill({ keyword: this.keyword, status: 1 }).then(response => {
				this.loadings(false);
