        ...
        <div class="col-md-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body" >
                ...
                <div class="form-group">
                  <label>Favicon</label>
                  <image-upload :oldImage="objData.favicon" type="avatar" v-model="objData.favicon" :title="'favicon'"></image-upload>
                </div>
                <div class="form-group">
                  <label>Logo</label>
                  <image-upload :oldImage="objData.logo" type="avatar" v-model="objData.logo" :title="'logo'"></image-upload>
                </div>
