		...
		<div class="row">
			<div class="col-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						<div class="row">
							<div class="col-md-3"><h4 class="card-title">Sửa thương hiệu</h4></div>
			...
			this.getInfoCate(this.objData)
				.then(response => {
					...
					if (response.data == null) {
						...
						this.objData.name = response.data.name
							? JSON.parse(response.data.name)
							: [];
						this.objData.content = response.data.content
                        ...
                        this.objData.description = response.data.description
