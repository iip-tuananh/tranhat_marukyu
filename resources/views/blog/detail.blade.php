            ...
            <div class="breadcrumb-noheading">
                <div class="container container-v2">
                    ...
                    <div class="bread-crumb">
                        ...
                        <a href="{{route('listCateBlog',['slug' => $blog_detail->cate->slug])}}">{{$cate_name}} <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                        <strong>{{ languageName($blog_detail->title) }}</strong>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-4 col-xl-3 ">
                            <div class="article_sidebar">
                                ...
                                <div class="banner_sidebar ">
                                    <a href="{{route('home')}}">
                                        <img class="w-100"
                                            src="{{url(''.$cate_image)}}" alt="{{$cate_name}}" loading="lazy">
                                    </a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="post-details">
                                    <div class="content-image-single">
                                        <div class="content-info">
                                            <h2 class="article_title">{{ languageName($blog_detail->title) }}</h2>
                                            <div class="cmt-author">
                                                <span class="author"><i class="fa fa-user"></i><a
                                                        href="#">Admin</a></span>
                                                <span class="date-post"><i class="fa fa-clock-o"></i><a
                                                        href="#">{{$blog_detail->created_at->format('d.M.Y')}}</a></span>
                                                <span class="comment_count"><i class="fa fa-comment"></i><a
                                                        href="#"
                                                        class="silver">0</a> comments</span>
                                            </div>
                                        </div>
                                        <div class="single-post-thumb">
                                            <img src="{{url(''.$blog_detail->image)}}"
                                                alt="{{ languageName($blog_detail->title) }}" loading="lazy"/>
                                        </div>
                                    </div>
                                ...
                                <div class="single-related-post ">
                                    ...
                                    <div class="row js_relate_post">
                                        ...
                                        <div class="blog_grid col-12">
                                            ...
                                            <div class="post-info">
                                                <h4 class="blog-title mb-0">{{languageName($item->cate->name)}}</h4>
                                                <h3 class="post-title mb-0"><a
                                                        href="{{route('detailBlog',['slug' => $item->slug])}}"
                                                        class="dark"
                                                        title="{{ languageName($item->title) }}">{{ languageName($item->title) }}</a></h3>
                                                <a class="btn_readmore"
                                                    href="{{route('detailBlog',['slug' => $item->slug])}}"><span>{{getLanguage('learn_more')}}</span></a>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
